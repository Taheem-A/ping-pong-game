...
export default function Ball({ leftPaddlePosition, rightPaddlePosition, setScore, ballPosition, setBallPosition, ballVelocity, setBallVelocity }) {
    const gameWidth = 640;
    ...
    return <div className="ball" style={{ top: ballPosition.y, left: ballPosition.x }}></div>;
}
